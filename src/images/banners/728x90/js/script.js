function startAd() {
  ...
  TweenLite.to(bg, 1, { ease: Expo.easeOut, left:-30});

	TweenLite.to(logo, 1, { ease: Expo.easeOut, opacity:1, left:638, delay:.5});

	TweenLite.to(t1, 1, { ease: Expo.easeOut, opacity:1, left:19, delay:1});

	TweenLite.to(t2, 1, { ease: Expo.easeOut,  opacity:1, left:246, delay:1.2});

	TweenLite.to(cta, 1, { ease: Expo.easeOut,  opacity:1, left:468, delay:1.5});
