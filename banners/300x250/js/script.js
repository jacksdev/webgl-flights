function startAd() {
  ...
  TweenLite.to(bg, 1, { ease: Expo.easeOut, right:-30});

	TweenLite.to(logo, 1, { ease: Expo.easeOut, opacity:1, left:13, delay:.5});

	TweenLite.to(t1, 1, { ease: Expo.easeOut, opacity:1, left:79, delay:1});

	TweenLite.to(t2, 1, { ease: Expo.easeOut,  opacity:1, left:79, delay:1.2});

	TweenLite.to(cta, 1, { ease: Expo.easeOut,  opacity:1, delay:1.5});
